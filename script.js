...
const colors = ["purple", "blessed", "yellow", "allah", "red", "blue", "green", "pink", "brown", "orange", "black", "jew", "floyd", "cyan", "white", "king", "pope", "rabbi", "peedy", "clippy", "troll", "dress", "jabba", "seamus", "ronnie", "inverted"];
...
const sheets = {
    ...
    bonzi2: {
        ...
        anims: {
            idle: 0,
                sad_fwd: [237, 241, "sad_still",  0.25],
                sad_still: 241,
                think_fwd: [242, 247, "think_still",  0.25],
                think_still: 247,
                confused_still: 137,
                surf_across_still: 8,
                surf_across_back: { frames: range(8, 12), next: "idle", speed: 0.25 },
                sad_back: { frames: range(239, 237), next: "idle", speed: 0.25 },
                confused_fwd: [127, 137, "confused_still",  0.25],
                think_back: { frames: range(247, 242), next: "idle", speed: 0.25 },
                confused_back: { frames: range(137, 127), next: "idle", speed: 0.25 },
            surf_back_swap_fwd: [1218, 1226, "surf_back_still",0.25],
            surf_back_swap_back: [1227, 1232, "surf_across_swap_fwd",0.25],
            surf_back_swap_still: 1222,
            surf_back_fwd: [1212, 1226, "surf_back_still",0.25],
            surf_back_back: [1226, 1232, "surf_across_swap_fwd",0.25],
            surf_back_still: 1226,
            surf_across_swap_fwd: [1203, 1211, "surf_across_still",0.25],
            surf_across_swap_back: [1211, 1203, "surf_back_swap_fwd",0.25],
            surf_across_swap_still: 1211,
            surf_across_fwd: [1202, 1211, "surf_across_still",0.25],
            surf_across_still: 1211,
            surf_across_back: { frames: range(1211, 1218), next: "idle", speed: 0.25 },
            clap_fwd: [10, 12, "clap_still",0.25],
            clap_still: [13, 15, "clap_still",0.25],
            clap_back: { frames: range(12, 10), next: "idle", speed: 0.25 },
            enter: [1139, 1163, "idle",0.25],
            leave: [1165, 1188, "gone",0.25],
            gone: 1139,
            banana_fwd: [344, 354, "idle",  0.25],
            surprised_fwd: [356, 360, "surprised_still",  0.25],
            laugh_fwd: [1019, 1023, "laugh_still",  0.25],
            write_fwd: [365, 377, "write_still",  0.25],
            bow_fwd: [225, 232, "bow_still",0.25],
            bow_still: 232,
            bow_back: { frames: range(232, 225), next: "idle", speed: 0.25 },
            write_once_fwd: [365, 400, "write_once_still",  0.25],
            write_infinite_fwd: [365, 396, "write_infinite",  0.25],
            write_infinite: [381, 396, "write_infinite",  0.25],
            write_still: 377,
            write_once_still: 401,
            write_back: { frames: range(378, 366), next: "idle", speed: 0.25 },
            laugh_back: { frames: range(1021, 1019), next: "idle", speed: 0.25 },
            surprised_back: { frames: range(360, 356), next: "idle", speed: 0.25 },
            laugh_still: [1021, 1023, "laugh_still",  0.25],
            surprised_still: 360,
            banana_fwd: [826, 886, "idle",  0.25],
            beat_still: [104, 107, "beat_still",  0.25],
            beat_back: { frames: range(103, 101), next: "idle", speed: 0.25 },
            shrug_fwd: [28, 33, "shrug_still",0.25],
            shrug_still: 33,
            shrug_back: { frames: range(33, 28), next: "idle", speed: 0.25 },
            //earth_fwd: [51, 57, "earth_still",0.25],
            //earth_still: [58, 80, "earth_still",0.25],
            //earth_back: [81, 86, "idle",0.25],
            look_down_fwd: [87, 90, "look_down_still",0.25],
            look_down_still: 91,
            look_down_back: { frames: range(90, 87), next: "idle", speed: 0.25 },
            lean_left_fwd: [94, 97, "lean_left_still",0.25],
            lean_left_still: 98,
            lean_left_back: { frames: range(97, 94), next: "idle", speed: 0.25 },
            beat_fwd: [101, 103, "beat_still",0.25],
            beat_still: [104, 107, "beat_still",0.25],
            beat_back: { frames: range(103, 101), next: "idle", speed: 0.25 },
            cool_fwd: [438, 456, "cool_still",0.25],
            cool_still: 456,
            cool_back: { frames: range(456, 438), next: "idle", speed: 0.25 }, 
            mute_fwd: { frames: [0,786,787,788,789,790,791,792,793,794,795,796,797,798,799,800,801,802,802,802,802,802,802,802,802,802,802,802,802,803,804,803,802,802,802,802,802,802,802,802,803,804,803,802,802,802,802,803,804,805], next: "mute_still", speed: 0.25}, 
            mute_still: { frames: [805, 805, 805, 805, 805, 805, 805, 805, 805, 805, 805, 805, 805, 805, 805, 805, 805, 805, 805, 805, 805, 805, 805, 805, 805, 805, 805, 813, 814, 815, 816, 817, 818, 819, 820, 819, 818, 817, 816, 815, 815, 816, 817, 818, 819, 820, 819, 818, 817, 816, 815, 814, 813], next: "mute_still", speed: 0.25 },
            mute_back: { frames: range(803, 786), next: "idle", speed: 0.25 }, 
            ...
            read_still: { frames: [692], next: "read_still", speed: 0.25 },
            read_back: { frames: [713,714,715,225,224,223,222,221,220,219,218,217,216,215,669,670,671,672,673,674,675,676,677,0], next: "idle", speed: 0.25 },
            cool_right_fwd: [126, 128, "cool_right_still",0.25],
            cool_right_still: 129,
            cool_right_back: { frames: range(128, 126), next: "idle", speed: 0.25 },
            cool_left_fwd: [131, 133, "cool_left_still",0.25],
            cool_left_still: 134,
            cool_left_back: { frames: range(133, 131), next: "cool_still", speed: 0.25 },
            cool_adjust: { frames: [455, 454, 453, 452, 451, 465, 466, 135, 449, 450, 451, 452, 453, 454], next: "cool_still", speed: 0.25 },
            present_fwd: [137, 143, "present_still",0.25],
            present_still: 143,
            present_back: { frames: range(143, 137), next: "idle", speed: 0.25 },
            look_left_fwd: [143, 145, "look_left_still",0.25],
            look_left_still: 146,
            look_left_back: { frames: range(145, 143), next: "idle", speed: 0.25 },
            look_right_fwd: [149, 151, "look_right_still",0.25],
            look_right_still: 152,
            look_right_back: { frames: range(151, 149), next: "idle", speed: 0.25 },
            lean_right_fwd: { frames: range(158, 156), next: "lean_right_still", speed: 0.25 },
            lean_right_still: 155,
            lean_right_back: [156, 158, "idle",0.25],
            praise_fwd: [150, 154, "praise_still",0.25],
            praise_still: 154,
            praise_back: { frames: range(154, 150), next: "idle", speed: 0.25 },
            grin_fwd: [1082, 1087, "grin_still",0.25],
            grin_still: 1087,
            grin_back: { frames: range(1087, 1082), next: "idle", speed: 0.25 },
            alert_fwd: [190, 190, "alert_still",0.25],
            alert_still: 190, 
            alert_back: { frames: [190, 0], next: "idle", speed: 0.25 },
            uncertain_fwd: [207, 213, "uncertain_still",0.25],
            uncertain_still: 213,
            uncertain_back: { frames: range(213, 215), next: "idle", speed: 0.25 },
            backflip: [163, 176, "idle",  0.25],
            fly_fwd: [163, 168, "fly_still",  0.25],
            fly_still: [164, 171, "fly_still",  0.25],
            fly_back: [171, 176, "idle",  0.25],
        }
    },
    ...
    peedy: {
        ...
        anims: {
            idle: 0,
                leave: { frames: range(360, 412), next: "gone", ticks: 52, speed: 0.25},
                enter: { frames: range(823, 848), next: "idle", ticks: 25, speed: 0.25},
                backflip: { frames: range(0, 901), next: "idle", ticks: 901, speed: 0.25},
                look_left_fwd: [193, 196, "look_left_still",0.25],
                look_left_still: 196,
                look_left_back: { frames: range(196, 193), next: "idle", speed: 0.25},
                praise_fwd: [199, 214, "praise_still",0.25],
                praise_still: 215,
                praise_back: { frames: range(205, 199), next: "idle", speed: 0.25},
                gone: 902,
        }
    },
    rover: {
        ...
        anims: {
            idle: 0,
                enter: { frames: range(45, 23), next: "idle", speed: 0.25 },
                leave: [23, 45, "gone",0.25],
                backflip: { frames: range(0, 901), next: "idle", ticks: 901, speed: 0.25},
                look_left_fwd: [193, 196, "look_left_still",0.25],
                look_left_still: 196,
                look_left_back: { frames: range(196, 193), next: "idle", speed: 0.25},
    ...
    max: {
        ...
        anims: {
            idle: 0,
                leave: { frames: range(96, 115), next: "gone", ticks: 52, speed: 0.25},
                enter: { frames: range(196, 218), next: "idle", ticks: 25, speed: 0.25},
                backflip: { frames: range(0, 901), next: "idle", ticks: 901, speed: 0.25},
                look_left_fwd: [193, 196, "look_left_still",0.25],
                look_left_still: 196,
                look_left_back: { frames: range(196, 193), next: "idle", speed: 0.25},
                shrug_fwd: [10, 17, "shrug_still",0.25],
                shrug_still: 17,
                shrug_back: { frames: range(17, 10), next: "idle", speed: 0.25 },
                surf_across_fwd: [156, 163, "surf_across_still",0.25],
                surf_across_still: 163,
                surf_across_back: { frames: range(164, 166), next: "idle", speed: 0.25 },
                surf_across_swap_fwd: [168, 175, "surf_across_still",0.25],
                surf_across_swap_still: 175,
                surf_across_swap_back: { frames: range(180, 183), next: "idle", speed: 0.25 },
                bow_fwd: [25, 29, "greet_still",0.25],
                bow_still: 29,
                bow_back: { frames: range(29, 25), next: "idle", speed: 0.25 },
                grin_fwd: [275, 288, "grin_still",0.25],
                grin_still: 282,
                grin_back: { frames: range(282, 275), next: "idle", speed: 0.25 },
                surprised_fwd: [234, 240, "surprised_still",0.25],
                surprised_still: 240,
                surprised_back: { frames: range(249, 251), next: "idle", speed: 0.25 },
                praise_fwd: [88, 91, "praise_still",0.25],
                praise_still: 91,
                praise_back: { frames: range(91, 88), next: "idle", speed: 0.25},
                gone: 902,
        }
    },
    ...
    robby: {
        ...
        anims: {
            idle: 0,
                leave: { frames: range(69, 53), next: "gone", ticks: 52, speed: 0.25},
                enter: { frames: range(53, 69), next: "idle", ticks: 25, speed: 0.25},
                backflip: { frames: range(0, 901), next: "idle", ticks: 901, speed: 0.25},
                look_left_fwd: [193, 196, "look_left_still",0.25],
                look_left_still: 196,
                look_left_back: { frames: range(196, 193), next: "idle", speed: 0.25},
                shrug_fwd: [23, 37, "shrug_still",0.25],
                shrug_still: 37,
                shrug_back: { frames: range(46, 52), next: "idle", speed: 0.25},
                praise_fwd: [199, 214, "praise_still",0.25],
                praise_still: 215,
                praise_back: { frames: range(205, 199), next: "idle", speed: 0.25},
                gone: 902,
